<template>
  <div>
    <b-button variant="success" size="sm" id="show-btn" @click="$bvModal.show('modal-3')">
      <i class="fas fa-pen"></i>
    </b-button>

    <b-modal id="modal-3" title="BootstrapVue" @hidden="resetFields">
      ...
      <div class="d-block text-center">
        <b-form>
          <b-form-group id="input-group-1" label="Titulo da atividade" label-for="input-1" style="margin-top: 0.5rem">
            <b-form-input id="input-1" v-model="title" required></b-form-input>
          </b-form-group>
          ...
          <b-row>
            <b-col cols="6">
              <b-form-group id="input-group-3" label="Data" label-for="input-3" style="margin-top: 0.5rem">
                <b-form-input id="input-3" v-model="date" type="date" required></b-form-input>
              </b-form-group>
            </b-col>

            <b-col cols="6">
              <b-form-group id="input-group-4" label="Hora" label-for="input-4" style="margin-top: 0.5rem">
                <b-form-input id="input-3" v-model="time" type="time" required></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
        </b-form>
